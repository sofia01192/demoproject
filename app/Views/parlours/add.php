...
<?php endif; ?>
<?php 
if(isset($parlourErrors)):?>
	<?php
	echo "<br>parlour errors<br>";
	 print_r($parlourErrors);?>
...
<?php 	$session = \Config\Services::session();	?>
	...
	<section class="contact-section spad">
		...
		<div class="container">
			<?php echo form_open('submitparlour', ['class' => 'contact-form', 'method' => 'post']);?>
			<div class="row branches">
				<div class="col-lg-12 ">
				<?php 	
				$user_id = $session->userData['id']; ?>
					<h2 class="contact-title">Parlour Details</h2>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<?php echo form_input('name', '', ['placeholder' => 'Brand Name', 'required' => 'required']);?>
						</div>
						<div class="col-md-6">
							<?php echo form_input('email', '', ['type' => 'email', 'placeholder' => 'Brand E-mail', 'required' => 'required|valid_email|is_unique[parlours.email]']);?>
						</div>
						<div class="col-md-6">
							<?php echo form_input('phone', '', ['type' => 'email', 'placeholder' => 'Brand Contact Phone', 'required' => 'required|max_lenght[11]|numeric']);?>
						</div>
					</div>					
				</div>
				<div class="col-lg-12 branch">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<?php echo form_input('branch_email', '', ['type' => 'email', 'placeholder' => 'Branch E-mail', 'required' => 'required|valid_email|is_unique[branches.email]']);?>
						</div>
						<div class="col-md-6">
							<?php echo form_input('branch_phone', '', ['type' => 'email', 'placeholder' => 'Branch Contact Phone', 'required' => 'required|max_lenght[11]|numeric']);?>
						</div>
						<div class="col-md-6">
